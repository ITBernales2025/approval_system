...
export const ApproverDashboard = () => {
  ...
  const {data: searchQuery, refetch: searchRefetch, isLoading:searchLoading} = useSearchQuery({page: ticketPage, query: search, id: userInfo._id})
  ...
  const {data: maxPageSearch,refetch: maxPagesRefetch} = useMaxPagesSearchQuery({query: search, id: userInfo._id})

...
export const SemiApproverDashboard = () => {
  ...
  const {data: allTicketWithPage, refetch:ticketPageRefetch,isLoading:allTicketLoading, isError:ticketPageError} = useAllTicketsWithPageQuery(ticketPage)
  ...
  useEffect(()=> {
    if(ticketPageError || searchError || maxPageError) {
      setQueryParams('error',true)
    }
  },[ticketPageError,searchError,maxPageError])

...
export const Register = () => {
  ...
  const {data: allBranches, isError} = useAllBranchesQuery()
        ...
        <div className="w-full rounded flex items-center justify-center mt-2 h-full ">
          {
            ...
            <form className={`py-10 gap-10  w-9/12 grid grid-cols-2 gap-x-10 border-2 px-10 rounded-md border-slate-500 shadow-xl shadow-black/20 duration-700 transition-all ease-in-out ${transition}`} onSubmit={handleSubmit} noValidate>
              ...
              <div className="w-full h-full  flex flex-col justify-center">
                ...
                <label className="w-full">
                  ...
                  <input 
                    ...
                    name="name"
                    autoComplete="name"
                    className="w-full border-2 border-slate-300 rounded outline-slate-500 p-2"
                    value={data.name} 
                ...
                <label className="w-full">
                  ...
                  <select 
                    id="type"
                    name="type"
                    className="w-full border-2 border-slate-300 rounded outline-slate-500 p-2" onChange={(e)=> setData({...data, type: e.target.value})} 
                    required>
                ...
                <label className="w-full">
                  ...
                  <select 
                    id="branchName"
                    name="branchName"
                    className="w-full border-2 border-slate-300 rounded outline-slate-500 p-2" onChange={(e)=> setData({...data, branch: e.target.value})} 
                    required>
              ...
              <label className="w-full relative">
                ...
                <input 
                  ...
                  className="w-full border-2 border-slate-300 rounded outline-slate-500 p-2" onChange={(e)=> setData({...data, confirmPass: e.target.value})} 
                  required/>
                {
                  confirm ? (

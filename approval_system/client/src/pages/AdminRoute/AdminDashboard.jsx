...
export const AdminDashboard = () => {
  ...
  const {data: searchQuery, refetch: searchRefetch, isLoading} = useSearchQuery({page: ticketPage, query: search, id: userInfo._id})
  ...
  const {data: maxPageSearch,refetch: maxPagesRefetch, error:maxPageError} = useMaxPagesSearchQuery({query: search, id: userInfo._id})
...
// ============================================================================
  return (
    <>
        ...
        <div className=" h-full flex flex-col pt-2 p-4">
          ...
          <div className="h-full  ">
            <div className="mt-1 h-full flex flex-col">
              ...
              {
                (!loadingTwp || !isLoading || tickets === undefined ) ? 
                (<>
                {tickets?.map((ticket)=> 
              ...
              <div className="flex border-b-4">
                ...
                <div className={`w-full p-3 h-96 ${updateOosComment && "border border-orange-500"}`}>
                  { !updateOosComment ? (
                      ...
                      <textarea className="w-full outline-none resize-none h-full" 
                      name="oosComment"
                      id="oosComment"
            ...
            }
            {
              ...
              <div className="flex border-b-4">
                ...
                <textarea 
                  ...
                  id="comment"
                  name="comment"
                  className={`w-full p-3 resize-none h-44 ${error && "border border-red-500"}`} placeholder="Write comment here...">
                </textarea>
              </div>
            }
            { 
              ...
              <>
                <label className="flex border-b-4">
                  <div className="w-full border-r-4 p-3 font-bold">Receiver :</div>
                    <input
                      ...
                      id="receiver_name"
                      name="receiver_name"
                      className={`w-full p-3 ${receiverError && "border border-red-500"}`} 
                      value={receiver} 
                ...
                <label className="flex border-b-4">
                  ...
                  <textarea 
                    ...
                    className={`w-full p-3  resize-none h-44  `} 
      ...
      {
        updateOosSuccess &&
        <Notification color="bg-orange-500" transitions={updateOosSuccess} success={()=> setUpdateOosSuccess(false)}>
